...
const Timeline = () => {
    return (
        <section className={styles.section} id="timeline">
           ...
           <TimelineCard direction={styles.right} title={"Data Structures And Algorithms"} date={"January 2023"} text={"Spending so much time working on my projects made me realize that I also needed to work on my data structures and algorithms department, so I decided to take a small break from my own projects and start working on leetcode questions, this is also the same time I enrolled into my DSA class"} parllaxValues={'20%'}/>
