...
const Timeline = () => {
    return (
        <section className={styles.section} id="timeline">
           ...
           <TimelineCard direction={styles.left} title={"Internship Search"} date={"August 2022"} text={"After spending half a year learning how to create solid full stack applications, i had determined that i was finally ready to start looking into internships which also coincides with the beginning of my DSA journey"} parllaxValues={'-20%'}/>
