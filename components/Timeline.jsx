...
const Timeline = () => {
    return (
        <section className={styles.section} id="timeline">
           ...
           <TimelineCard direction={styles.left} title={"Data Structures And Algorithms"} date={"January 2023"} text={"Spending so much time working on my projects realized I also needed to work on my data structures and algorithms department, so I decided to take a small break from my own projects and start working on leet code questions, this is also the same time i enrolled into my DSA class"} parllaxValues={'-20%'}/>
